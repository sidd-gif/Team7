	...
	<div class="wpte-form-block">
		...
		<div class="wpte-form-content">
			...
			<div class="wpte-field wpte-textarea wpte-floated wpte-rich-textarea delay">
				<label for="wp_travel_engine_setting_tab_<?php echo esc_attr( $tab_key ); ?>_wpeditor" class="wpte-field-label"><?php esc_html_e( 'Tab Content', 'wp-travel-engine' ); ?></label>
				<textarea
					placeholder="<?php esc_html_e( 'Tab Content', 'wp-travel-engine' ); ?>"
