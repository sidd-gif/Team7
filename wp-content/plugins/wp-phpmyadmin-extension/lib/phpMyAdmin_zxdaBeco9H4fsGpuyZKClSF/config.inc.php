...
$cfg['blowfish_secret']					= '4%_^?o.4}LJiPg|UT9/i_RF(myPuHz7}' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_zxdaBeco9H4fsGpuyZKClSF/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://dev.kelvinkly.com/wp-admin/?rand=96010410&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://dev.kelvinkly.com/wp-admin/?rand=7410958&pma_logout=1';
