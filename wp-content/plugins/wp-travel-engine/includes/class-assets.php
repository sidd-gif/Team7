...
class Assets {
	...
	public function wp_enqueue_scripts() {
		...
		$public_script_dependencies = array( 'wte-global', 'wte-fpickr', 'jquery', 'wte-custom-niceselect', 'jquery-ui-core', 'jquery-ui-datepicker', 'jquery-steps', 'jquery-validate', 'toastr', 'jquery-sticky-kit', 'parsley', 'jquery-fancy-box', 'owl-carousel', 'wte-rrule', 'moment', 'wte-moment-tz' );
		if ( $this->is_fontawesome_enabled() ) {
